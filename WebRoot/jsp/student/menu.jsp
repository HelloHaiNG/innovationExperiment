							...
							<TBODY>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_selfInfo.action"
														target=main>－查看个人信息</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_toUpdatePwdPage.action"
														target=main>－修改登陆密码</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_exit.action"
														target=main>－退出登陆</A>
													</TD>
												</TR>
											</TBODY>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_toTrainIntroducePage.action"
														target=main>－ 军训介绍</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_toStoryPage.action"
														target=main>－ 军训回顾</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/classmission_viewClassMission.action"
														target=main>－查看班级公告</A>
													</TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
										class=span id=table_4Span>＋</SPAN> 表白墙</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/love_toLovePage.action"
														target=main>－我要表白</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/love_myLoveList.action"
														target=main>－我的表白</A>
													</TD>
												</TR>
                                                <TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> 军训聊天室</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
										class=span id=table_6Span>＋</SPAN>军训来稿</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_7');"><SPAN
										class=span id=table_7Span>＋</SPAN> 军训评教</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_7 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/masterscore_toScorePage.action"
														target=main>－ 我要评教</A>
													</TD>
												</TR>
												</TBODY>
