...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临军训聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临军训聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
...
<body>
	...
	<table width="778" height="95" border="0" align="center"
		...
		background="TrainChat/images/bottom.jpg">
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<td align="right">
				    <a href="${pageContext.request.contextPath}/passageKind/PassageTrainAction.action" class="abc">退出聊天室</a>
				</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
