	...
	<FORM id=form1 name=form1 action=YHMenu.aspx method=post>
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15><IMG
						src="/innovationExperiment/images/new_005.jpg" border=0></TD>
					<TD align=middle width=180
						background=/innovationExperiment/images/new_006.jpg height=35><B>军训网站
							－功能菜单</B></TD>
					<TD width=15><IMG
						src="/innovationExperiment/images/new_007.jpg" border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
							...
							<TBODY>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/admin_selfInfo.action"
														target=main>－查看个人信息</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/admin_toUpdatePwdPage.action"
														target=main>－修改登陆密码</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/admin_exit.action"
														target=main>－退出登陆</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/admin_toTrainIntroducePage.action"
														target=main>－ 军训介绍</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/admin_toStoryPage.action"
														target=main>－ 军训回顾</A></TD>
												</TR>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><<A class=style2
														...
														target=main>－ 教官列表</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_toFindMasterMoreConditionPage.action"
														target=main>－教官查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_studentList.action?currentPage=1"
														target=main>－新生信息</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
									...
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/fellowship_shipAllResultList.action"
														target=main>－军训联谊结果</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														...
														target=main>－ 表白墙</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/love_examLove.action"
														target=main>－ 审核表白</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														...
														target=main>－我要聊天</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/illegalword_list.action"
														target=main>－敏感字列表</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/illegalword_toAddPage.action"
														target=main>－添加敏感字</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_7');"><SPAN
										class=span id=table_7Span>＋</SPAN>军训来稿</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_7 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/article_toAddPage.action"
														target=main>－添加稿件</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
									...
									<TD>
										<TABLE id=table_8 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/masterscore_list.action"
														target=main>－教官评教</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_scoreList.action"
														target=main>－新生成绩</A>
													</TD>
												</TR>
											</TBODY>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_9');"><SPAN
										class=span id=table_9Span>＋</SPAN>军训更替</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_9 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/master_toAddPage.action"
														target=main>－添加教官</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_toAddPage.action"
														target=main>－添加新生</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/master_delete.action"
														target=main>－清空所有教官信息</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/student_delete.action"
														target=main>－清空所有新生信息</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/love_delete.action"
														target=main>－清空所有表白信息</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/fellowship_delete.action"
														target=main>－清空所有联谊信息</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/article_delete.action"
														target=main>－清空所有稿件信息</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15><IMG
						src="/innovationExperiment/images/new_010.jpg" border=0></TD>
					<TD align=middle width=180 background=images/new_011.jpg height=15></TD>
					<TD width=15><IMG
						src="/innovationExperiment/images/new_012.jpg" border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
	</FORM>
